...
"moe2016":[
  ...
  {
    "q": "What is the major limitation of the Master Theorem?",
    "options": [
      "It cannot be applied if subproblems are of significantly different sizes",
      "It cannot handle recursion trees with depth greater than log n",
      "It assumes the input size is always a power of two",
      "It gives only best-case complexity, not worst-case"
    ],
    "answer": 0,
    "explanation": "Master Theorem works mainly for recurrences with equal-sized subproblems."
  },
  {
    "q": "Which edge type in DFS traversal indicates a cycle in a graph?",
    "options": [
      "Forward edge",
      "Tree edge",
      "Back edge",
    ...
    "answer": 2,
    "explanation": "A back edge connects a node to one of its ancestors, indicating a cycle."
  },
  {
    "q": "Which condition makes a problem suitable for dynamic programming?",
    "options": [
      "Best local choice each step",
      "Overlapping subproblems and optimal substructure",
      "Only leftmost recursion path considered",
      "Independent subproblems with simple combination"
    ],
    "answer": 1,
    "explanation": "Dynamic programming requires overlapping subproblems and optimal substructure."
  },
  {
    "q": "How do greedy algorithms operate?",
    "options": [
      "Prioritize minimum recursion depth",
      "Explore all combinations",
      "Choose best local option hoping for global optimum",
      "Reuse overlapping subproblems"
    ],
    "answer": 2,
    "explanation": "Greedy algorithms make locally optimal choices to reach global optimum."
  },
  {
    "q": "What is a rule-based system in expert systems?",
    "options": [
      "Applies predefined rules to infer conclusions",
      "Automatically processes data",
      "Generates rules automatically from data",
      "Has no predefined knowledge"
    ],
    "answer": 0,
    "explanation": "Rule-based systems use IF–THEN rules to derive conclusions."
  },
  {
    "q": "What is the time complexity of Minimax without pruning (branching factor b, depth d)?",
    "options": [
      "O(b + d)",
      "O(b^d)",
      "O(d^b)",
    ...
    "answer": 1,
    "explanation": "Minimax explores the full game tree of size b^d."
  },
  {
    "q": "Which is an example of a simple reflex agent?",
    "options": [
      "Self-driving car",
      "Chatbot",
      "Thermostat turning heater on when cold",
      "Robot learning from experience"
    ],
    "answer": 2,
    "explanation": "Simple reflex agents respond directly to current percepts."
  },
  {
    "q": "Which search algorithm is guaranteed optimal with uniform step costs?",
    "options": [
    ...
    "answer": 0,
    "explanation": "BFS finds the shortest path when step costs are equal."
  },
  {
    "q": "AI problems can be solved by searching when:",
    "options": [
      "Solution is hardcoded",
      "Path to goal is unknown",
      "System has complete information",
      "Solution provided by user"
    ],
    "answer": 1,
    "explanation": "Search is used when the path to the goal must be discovered."
  },
  {
    "q": "In robotic exploration, which search is typically preferred?",
    "options": [
      "Depth-First Search",
      "Blind Search",
      "A* Search",
    ...
    "answer": 2,
    "explanation": "A* is efficient and optimal with good heuristics."
  },
  {
    "q": "What does ∃x (Dog(x) ∧ Barks(x)) mean?",
    "options": [
      "All dogs bark",
      "No dogs bark",
      "Some dogs don’t bark",
      "There is at least one dog that barks"
    ],
    "answer": 3,
    "explanation": "Existential quantifier means at least one instance exists."
  },
  {
    "q": "Primary concern in data center management?",
    "options": [
      "Designing websites",
      "Managing power, cooling, fire safety",
      "Social media engagement",
      "Monitoring internal traffic"
    ],
    "answer": 1,
    "explanation": "Infrastructure reliability is critical in data centers."
  },
  {
    "q": "Key principle of system administration?",
    "options": [
      "Installing multiple software",
      "Keeping systems outdated",
      "Automating repetitive tasks",
      "Manual backups"
    ],
    "answer": 2,
    "explanation": "Automation improves efficiency and reliability."
  },
  {
    "q": "First step in OS bootstrapping?",
    "options": [
      "Loading OS kernel into memory",
      "Initializing multi-user operations",
      "Configuring network",
      "Executing daemons"
    ],
    "answer": 0,
    "explanation": "Bootloader loads the kernel into memory."
  },
  {
    "q": "Primary function of a UNIX/Linux shell?",
    "options": [
      "Manage hardware",
      "Graphical interface",
    ...
    "answer": 2,
    "explanation": "Shell acts as command interpreter."
  },
  {
    ...
    "answer": 2,
    "explanation": "Page fault occurs when requested page is not in RAM."
  },
  {
    "q": "Incorrect default gateway impact?",
    "options": [
      "Cannot communicate with remote networks",
      "Cannot communicate locally",
      "Cannot communicate anywhere",
      "Cannot get DHCP IP"
    ],
    "answer": 0,
    "explanation": "Local communication works; remote fails."
  },
  {
    "q": "Primary purpose of log rotation?",
    "options": [
      "Delete logs",
      "Disable logging",
      "Prevent storage overflow and organize records",
      "Random rename"
    ],
    "answer": 2,
    "explanation": "Log rotation manages storage and archives logs."
  },
  {
    "q": "When is input accepted by a Turing Machine?",
    "options": [
      "Any state with no move",
      "Consumes all input",
      "Halts in final state",
      "Infinite loop"
    ],
    "answer": 2,
    "explanation": "Acceptance occurs when machine halts in accept state."
  },
  {
    "q": "Which can be modeled using a Turing Machine?",
    "options": [
      "Non-RE languages",
      "NFA",
      "PDA",
    ...
    "answer": 3,
    "explanation": "DFA behavior can be simulated by a TM."
  },
  {
    "q": "Which statement is incorrect?",
    "options": [
      "All recursive languages are RE",
      "All recognizable languages are decidable",
      "All RE languages are recursive",
      "Decidable problems cannot be modeled by TM"
    ],
    "answer": 2,
    "explanation": "Not all recursively enumerable languages are recursive."
  },
  {
    ...
    "options": [
      ...
      "DFA have memory",
      "PDA have unrestricted memory"
    ],
    "answer": 1,
    "explanation": "TM has unbounded tape memory."
  },
  {
    "q": "When are two grammars equivalent?",
    "options": [
      "Same language",
      "Subset relation",
      "Same alphabet",
    ...
    "answer": 0,
    "explanation": "Equivalent grammars generate the same language."
  },
  {
    "q": "Which is a regular language?",
    "options": [
    ...
    "answer": 3,
    "explanation": "Even number of zeros can be recognized by finite automaton."
  },
  {
    "q": "Notation describing sequence of states for input?",
    "options": [
      "Automaton",
    ...
    "answer": 1,
    "explanation": "Instantaneous description represents current configuration."
  },
  {
    "q": "Most secure but slower firewall?",
    "options": [
      "Packet filtering",
      "Proxy firewall",
      "Stateful inspection",
    ...
    "answer": 1,
    "explanation": "Proxy firewalls inspect full traffic but add latency."
  },
  {
    "q": "Access control based on user identity?",
    "options": [
      "MAC",
      "RBAC",
      "DAC",
    ...
    "answer": 2,
    "explanation": "DAC is based on owner/user identity."
  },
  {
    "q": "Brute-force attack tries to:",
    "options": [
      "Guess key by all combinations",
      "Guess algorithm",
      "Overload CPU",
      "Social engineering"
    ],
    "answer": 0,
    "explanation": "Brute force tests all possible keys."
  },
  {
    "q": "Same key for encryption and decryption?",
    "options": [
      "Public key",
      "Asymmetric",
      "Symmetric",
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Input sanitization prevents script injection."
  },
  {
    "q": "Common software vulnerability?",
    "options": [
      "SQL injection",
    ...
    "answer": 0,
    "explanation": "SQL injection exploits input handling flaws."
  },
  {
    "q": "Example of multi-factor authentication?",
    "options": [
    ...
    "answer": 2,
    "explanation": "Combines knowledge and biometric factors."
  },
  {
    "q": "FIRST(B) for grammar B → bB | cA | b?",
    "options": [
      "a",
      "b",
      "c",
    ...
    "answer": 3,
    "explanation": "Productions start with terminals b and c."
  },
  {
    "q": "Bottom-up parsing action moving terminals to stack?",
    "options": [
      "Shift",
      "Accept",
      "Reduce",
    ...
    "answer": 0,
    "explanation": "Shift moves input symbol to stack."
  },
  {
    "q": "Grammar with only synthesized attributes?",
    "options": [
      "S-attributed",
      "L-attributed",
      "M-attributed",
    ...
    "answer": 0,
    "explanation": "S-attributed grammars use synthesized attributes only."
  },
  {
    "q": "Attribute computed from children values?",
    "options": [
      "Inherited",
      "Dependency",
      "Synthesized",
    ...
    "answer": 2,
    "explanation": "Synthesized attributes depend on child nodes."
  },
  {
    "q": "Used to determine a series of characters as a token?",
    "options": [
      "Lexeme",
      "Alphabet",
      "Grammar",
    ...
    "answer": 0,
    "explanation": "Lexeme is the character sequence forming a token."
  },
  {
    "q": "Other name for bottom-up parsing?",
    "options": [
    ...
    "answer": 0,
    "explanation": "Bottom-up parsing is also called shift-reduce parsing."
  },
  {
    "q": "Grammar producing more than one parse tree?",
    "options": [
      "Regular",
      "Ambiguous",
      "Unambiguous",
    ...
    "answer": 1,
    "explanation": "Ambiguous grammars generate multiple parse trees."
  },
  {
    "q": "Which is not a parsing approach?",
    "options": [
      "Top-down",
      "Bottom-up",
      "Left-to-right",
    ...
    "answer": 2,
    "explanation": "Left-to-right is scanning direction, not a parsing approach."
  },
  ...
  {
    "q": "What does the following PHP code snippet do? $stmt=$conn->prepare(\"SELECT * FROM users WHERE id=?\"); $stmt->bind_param(\"i\", $id); $stmt->execute();",
    "options": [
    ...
    "answer": 2,
    "explanation": "Prepared statements with parameter binding help prevent SQL injection attacks."
  },
  {
    "q": "What is the difference between visibility: hidden and display: none?",
    "options": [
      "Both remove the element from the document flow",
      "visibility: hidden hides the element and removes its space",
      "display: none hides the element but keeps its space",
      "visibility: hidden hides the element but keeps its space; display: none removes it entirely",
      "display: none removes it entirely"
    ],
    "answer": 3,
    "explanation": "visibility: hidden keeps the element's layout space, while display: none removes it completely from layout."
  },
  {
    "q": "Which MySQLi-related function is used to prevent XSS (Cross-Site Scripting)?",
    "options": [
    ...
    "answer": 1,
    "explanation": "htmlspecialchars() converts special characters into HTML entities to prevent XSS."
  },
  {
    "q": "Which statement is true about let, const, and var in JavaScript?",
    "options": [
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "ID selectors (#header) have higher specificity than class or element selectors."
  },
  {
    "q": "Which attribute of the <form> element prevents validation when submitted?",
    "options": [
      "novalidate",
      "no-validate",
      "validate=\"false\"",
    ...
    "answer": 0,
    "explanation": "The novalidate attribute disables built-in browser validation."
  },
  {
    "q": "Which of the following is not true about deadlocks?",
    "options": [
      "Deadlocks can be avoided by defining a global resource acquisition order",
      "Deadlocks can only occur if there is a circular wait",
      "Strict priority schedulers use priority donation to prevent deadlocks",
      "A program in a safe state can eventually deadlock",
      "None of the above"
    ],
    "answer": 3,
    "explanation": "A safe state means the system can avoid deadlock; therefore it cannot eventually deadlock."
  },
  {
    "q": "Which best describes a race condition?",
    "options": [
      "Multiple processes access shared resources concurrently in an unsafe manner",
      "Processes run on different CPUs",
      "Two processes share the same memory space",
      "Processes are in a deadlock"
    ],
    "answer": 0,
    "explanation": "Race conditions occur when concurrent processes access shared data without proper synchronization."
  },
  {
    "q": "Which statement about a device controller is incorrect?",
    "options": [
      "Works as an interface between a device and a driver",
      "Performs error correction if necessary",
      "Converts serial bit stream to blocks of bytes",
      "Software modules plugged into OS to handle a device",
      "None of the above"
    ],
    "answer": 3,
    "explanation": "Device drivers are software modules; device controllers are hardware components."
  },
  {
    "q": "Logical memory is broken into blocks of the same size called _______.",
    "options": [
      "Pages",
      "Frames",
      "Page table",
    ...
    "answer": 0,
    "explanation": "Logical memory uses pages, while physical memory uses frames."
  },
  {
  ...
  {
    "q": "What is the main advantage of Round Robin scheduling?",
    "options": [
      "Fair allocation of CPU time",
      "Higher priority to CPU-bound processes",
      "Minimizes waiting time",
      "Reduces context switches"
    ],
    "answer": 0,
    "explanation": "Round Robin ensures fairness by giving each process equal time slices."
  },
  {
    "q": "What does swapping refer to in memory management?",
    "options": [
      "Moving cache to main memory",
      "Moving processes between main memory and secondary storage",
      "Shuffling pages to reduce faults",
      "Resizing partitions dynamically"
    ],
    "answer": 1,
    "explanation": "Swapping moves entire processes between RAM and disk."
  },
  {
    "q": "What is the main goal of Software Engineering?",
    "options": [
      "Create software fast",
      "Write code without documentation",
      "Develop reliable, maintainable, efficient software",
      "Avoid standard processes"
    ],
    "answer": 2,
    "explanation": "Software engineering focuses on quality, maintainability, and efficiency."
  },
  {
    "q": "Which best describes a software process model?",
    "options": [
      "Debugging tool",
      "Set of activities producing a software product",
      "Always executed the same way",
      "Programming model"
    ],
    "answer": 1,
    "explanation": "A process model defines development activities and outputs."
  },
  {
    "q": "Which model suits well-understood requirements?",
    "options": [
      "Waterfall",
      "Agile",
      "Spiral",
    ...
    "answer": 0,
    "explanation": "Waterfall works best when requirements are clear and stable."
  },
  {
    "q": "In the college portal system, which model represents instructor?",
    "options": [
      "Class",
      "Object",
      "Use case",
    ...
    "answer": 3,
    "explanation": "Instructor interacts with the system externally, so it is an actor."
  },
  {
    "q": "Which best models the grade report?",
    "options": [
      "Entity class",
      "Boundary class",
      "Control class",
    ...
    "answer": 0,
    "explanation": "Grade report represents stored data, so it is an entity."
  },
  {
    "q": "Which is a possible use case?",
    "options": [
      "Grade report",
      "Instructor",
      "Portal",
    ...
    "answer": 3,
    "explanation": "Use cases represent system functions such as generating grades."
  },
  {
    "q": "A system design should be done based on …",
    "options": [
      "As-is scenario",
      "Visionary scenario",
      "Control class",
    ...
    "answer": 1,
    "explanation": "Design is based on the desired future (visionary) system."
  },
  {
    "q": "Which is true about components?",
    "options": [
      "Deployable product delivering subsystem services",
      "Cannot be reused",
      "Always purchased from COTS",
      "Useful but does not support modularity"
    ],
    "answer": 0,
    "explanation": "Components are modular deployable units providing subsystem functionality."
  },
  {
    "q": "What is the role of non-functional requirements (NFRs)?",
    "options": [
      "Define services",
      "Specify programming language",
      "Describe system performance under conditions",
      "Not considered in design"
    ],
    "answer": 2,
    "explanation": "NFRs define performance, reliability, scalability, and other quality attributes."
  },
  {
    "q": "Which violates characteristics of a valid algorithm?",
    "options": [
      "Finite steps",
      "Accepts inputs",
      "Subjective interpretation of steps",
      "Clearly defined operations"
    ],
    "answer": 2,
    "explanation": "Algorithms must have precise, unambiguous steps."
  },
  {
    "q": "Why do we analyze algorithms?",
    "options": [
      "Check syntax",
      "Prove correctness and efficiency",
      "Reduce code lines",
      "Determine behavior"
    ],
    "answer": 1,
    "explanation": "Algorithm analysis evaluates correctness and performance efficiency."
  },
  {
    "q": "What is the RAM model used for in algorithm analysis?",
    "options": [
      "Distributed computing",
      "Estimating hardware costs",
      "Modeling memory hierarchy",
      "Defining fundamental operations of a computer"
    ],
    "answer": 3,
    "explanation": "RAM model assumes uniform cost operations to analyze algorithms theoretically."
  },
  ...
  {
    "q": "What are the values of A, B, C and D after executing the given C++ code fragment?",
    "options": [
      "5, 9, -4, 0",
      "6, 8, -3, 6",
      "6, 9, -3, 5",
    ...
    "answer": 1,
    "explanation": "++A makes A = 6, so C = 6 − 9 = −3. B-- uses 9 then decreases to 8. D = −3 + 9 = 6."
  },
  {
    "q": "What will be the value of count and sum if a user provides 7.2 as the value of x?",
    "options": [
      "0, 10.2",
      "10.2, 10.2",
      "0, 3",
    ...
    "answer": 3,
    "explanation": "Since x = 7.2 (> 6), the if condition is false, so sum remains 3. count = (count += 1) * sum = 1 * 3 = 3, which is not listed."
  },
  {
    "q": "How many times will the message “Hello” be displayed?",
    "options": [
      "0",
      "6",
      "3",
    ...
    "answer": 2,
    "explanation": "The inner loop runs 3 times (m = 6, 7, 8). After that m = 9, so it never runs again. Total = 3."
  },
  {
    "q": "What does the statement cout<<*t; print?",
    "options": [
      "The address of x",
      "3",
      "7",
    ...
    "answer": 1,
    "explanation": "t points to x, and x = 3, so *t prints 3."
  },
  {
    "q": "What will be the output of the struct Person code?",
    "options": [
      "25 25",
      "25 30",
      "30 30",
    ...
    "answer": 1,
    "explanation": "p2 is a copy of p1. Changing p2.age does not affect p1.age."
  },
  {
    "q": "What will be the output of the enum Months code?",
    "options": [
    ...
    "answer": 3,
    "explanation": "The loop increments mon twice per iteration, ending with mon = 13."
  },
  {
    "q": "Which function returns the current position of the file pointer for an output stream?",
    "options": [
      "fileout.tellg()",
      "fileout.tellp()",
      "fileout.seekg()",
    ...
    "answer": 1,
    "explanation": "tellp() returns the current put pointer position for output streams."
  },
  {
    "q": "What is the primary purpose of concurrency control protocols?",
    "options": [
    ...
    "answer": 1,
    "explanation": "Concurrency control ensures that concurrent transactions produce a serializable schedule."
  },
  {
    "q": "What is a deadlock in concurrency control?",
    "options": [
      "Transactions waiting for each other to release locks",
      "Transaction unable to acquire lock because it is busy",
      "Transaction rolled back due to conflict",
      "Transaction committed successfully but rolled back"
    ],
    "answer": 0,
    "explanation": "Deadlock occurs when transactions wait indefinitely for each other’s locks."
  },
  {
    "q": "Which command should A1 issue to grant privileges without propagation?",
    "options": [
      "GRANT INSERT, DELETE ON EMPLOYEE, DEPARTMENT TO A2 WITH GRANT OPTION.",
      "GRANT INSERT, DELETE ON EMPLOYEE, DEPARTMENT TO A2;",
      "GRANT SELECT ON EMPLOYEE, DEPARTMENT TO A2 WITH REVOKE OPTION;",
      "GRANT UPDATE ON EMPLOYEE, DEPARTMENT TO A2 WITH ALLOW OPTION;"
    ],
    "answer": 1,
    "explanation": "Without WITH GRANT OPTION, privileges cannot be propagated."
  },
  {
    "q": "Which statement about database recovery strategies is correct?",
    "options": [
      "Force simplifies recovery by flushing updates to disk at commit.",
      "No-Steal allows flushing before commit.",
      "Steal prevents flushing before commit.",
      "No-Force reduces I/O by flushing immediately."
    ],
    "answer": 0,
    "explanation": "Force writes all modified pages to disk at commit, simplifying recovery."
  },
  {
    "q": "What is the impact of coarse granularity on concurrency?",
    "options": [
    ...
    "answer": 2,
    "explanation": "Larger lock units reduce the number of transactions that can proceed concurrently."
  },
  {
    "q": "What must be obtained before deleting a data item?",
    "options": [
      "Shared lock",
      "Intention lock",
      "Write lock",
    ...
    "answer": 2,
    "explanation": "Deletion requires an exclusive (write) lock."
  },
  {
    "q": "Which backup copies only data changed since the last backup?",
    "options": [
      "Full Backup",
      "Incremental Backup",
      "Differential Backup",
    ...
    "answer": 1,
    "explanation": "Incremental backup saves only changes since the last backup."
  },
  {
    "q": "What is the primary purpose of database recovery?",
    "options": [
      "Increase performance",
      "Reduce redundancy",
      "Enhance security",
      "Bring database to last consistent state"
    ],
    "answer": 3,
    "explanation": "Recovery restores the database to the last consistent state after failure."
  },
  {
    "q": "What is the primary notion of RBAC?",
    "options": [
      "Permissions tied to users",
      "Permissions tied to roles",
      "Permissions based on requests",
      "Automatic assignment"
    ],
    "answer": 1,
    "explanation": "RBAC assigns permissions to roles, and users are assigned roles."
  },
  {
    "q": "Which principle states data must be recorded at the time of action?",
    "options": [
      "Contemporaneous",
      "Attributable",
      "Legible",
    ...
    "answer": 0,
    "explanation": "Contemporaneous means recording data at the time of the event."
  },
  {
    "q": "If A revokes privileges granted to B, what happens to privileges B propagated?",
    "options": [
      "Remain active",
    ...
    "answer": 1,
    "explanation": "Revocation cascades to dependent grants."
  },
  {
    "q": "What is the purpose of savepoints in nested transactions?",
    "options": [
      "Encrypt data",
    ...
    "answer": 1,
    "explanation": "Savepoints allow partial rollback to a known state."
  },
  {
    "q": "Which feature is unique to object-oriented databases?",
    "options": [
      "Use SQL",
      "Handle large data",
      "Store data in objects and classes",
      "Rows and columns"
    ],
    "answer": 2,
    "explanation": "OODB stores data as objects with classes and inheritance."
  },
  {
    "q": "What is an advantage of relational databases over object-oriented databases?",
    "options": [
      "Simple and widespread SQL use",
      "Compatibility with NoSQL",
      "Complex data types",
      "Hierarchical data"
    ],
    "answer": 0,
    "explanation": "Relational databases benefit from mature SQL standards and adoption."
  },
  {
    "q": "Which declaration correctly creates the given 2D table?",
    "options": [
    ...
    "answer": 3,
    "explanation": "Java allows jagged arrays, so rows can have different lengths."
  },
  {
    "q": "Which of the following is a good candidate to be static?",
    "options": [
      "PI field of a circle class",
      "Method displaying salary of Employee",
      "Method calculating hypotenuse",
      "Name field of Student",
      "All except B"
    ],
    "answer": 4,
    "explanation": "Constants and utility methods can be static; instance-specific methods/fields should not."
  },
  {
    "q": "What is true about the accessModifier in method definition?",
    "options": [
      "Must always be private or public",
      "Can be omitted but only private or public allowed",
      "Can be omitted or chosen from several options",
      "Must match return type",
      "All of the above"
    ],
    "answer": 2,
    "explanation": "It may be omitted (default access) or specified as public, private, protected, etc."
  },
  {
    "q": "What is the output of the given Java inheritance code?",
    "options": [
      "4",
      "25",
      "12",
    ...
    "answer": 1,
    "explanation": "Constructor chaining results in num = 25, then num1 = num, so display prints 25."
  },
  ...
  {
    "q": "Which one of the following is important to implement dynamic Polymorphism?",
    "options": [
    ...
    "answer": 3,
    "explanation": "Dynamic polymorphism requires inheritance, method overriding, and polymorphic references."
  },
  {
    "q": "What must a non-abstract child do about an abstract method in its parent class?",
    "options": [
      "Override the abstract method with the same signature and return type",
      "Define a similar method with a different return type",
      "Must not define any method with the same signature",
      "Define another abstract method",
      "All of the above"
    ],
    "answer": 0,
    "explanation": "A non-abstract child class must implement (override) all inherited abstract methods."
  },
  {
    "q": "Which of the following is true about inheritance and interfaces?",
    "options": [
      "A child class can extend a parent or implement an interface, but not both",
      "A child class can extend just one parent and implement just one interface",
      "A child class can extend just one parent and implement zero or more interfaces",
      "A child class can extend zero or more parents and implement zero or more interfaces"
    ],
    "answer": 2,
    "explanation": "Java supports single inheritance (one parent class) and multiple interface implementation."
  },
  {
    "q": "Which best describes CPU involvement in programmed I/O, interrupt-driven I/O, and DMA?",
    "options": [
      "Programmed I/O wastes CPU cycles, interrupt-driven allows CPU work until interrupt, DMA minimizes CPU involvement",
      "Programmed and interrupt-driven use same CPU time, DMA adds overhead",
      "Interrupt-driven wastes more CPU than programmed I/O, DMA wastes most",
      "All require identical CPU effort"
    ],
    "answer": 0,
    "explanation": "DMA transfers data directly between memory and device with minimal CPU intervention."
  },
  {
    "q": "Which statement is true about memory-mapped I/O vs port-mapped I/O?",
    "options": [
      "Memory-mapped uses load/store and same address space, port-mapped uses separate instructions and space",
      "Memory-mapped uses separate address space",
      "Port-mapped uses general memory space",
      "Memory-mapped requires special I/O pins",
      "Memory-mapped cannot use DMA"
    ],
    "answer": 0,
    "explanation": "Memory-mapped I/O shares address space with memory and uses standard instructions."
  },
  {
    "q": "Which technique allows an I/O device to transfer a block of data to memory without continuous CPU intervention?",
    "options": [
    ...
    "answer": 2,
    "explanation": "DMA enables devices to transfer blocks directly to memory without CPU involvement."
  },
  {
    "q": "Which statement about RISC versus CISC architectures is generally true?",
    "options": [
      "RISC has many complex instructions",
      "Both execute one instruction per clock",
      "RISC uses fixed instruction length while CISC uses variable length",
      "RISC requires microcode but CISC does not"
    ],
    "answer": 2,
    "explanation": "RISC architectures use simple fixed-length instructions; CISC often uses variable-length instructions."
  },
  {
    "q": "What is the correct sequence of micro-operations for the fetch phase?",
    "options": [
      "PC → MAR, Read; MDR → IR; PC ← PC + 1",
      "PC → IR, PC ← PC + 1; IR → MAR",
      "IR → MDR, MDR → PC; MAR ← PC + 1",
      "MAR → PC; PC → IR; MDR ← PC + 1"
    ],
    "answer": 0,
    "explanation": "The PC value is sent to MAR, memory is read, instruction loaded into IR, and PC incremented."
  },
  {
    "q": "In an instruction ADD R1, R2, R3, which operation occurs?",
    "options": [
      "R2 ← R1 + R3 by Control Unit",
      "R1 ← R2 + R3 by ALU",
      "Memory read and write to R3",
      "Instruction moved to stack"
    ],
    "answer": 1,
    "explanation": "ALU adds contents of R2 and R3 and stores result in R1."
  },
  {
    "q": "What is the maximum number of IP addresses assignable to hosts with subnet mask 255.255.255.224?",
    "options": [
      "14",
      "15",
      "30",
    ...
    "answer": 2,
    "explanation": "255.255.255.224 is /27 giving 32 addresses, minus network and broadcast = 30 hosts."
  },
  {
    "q": "Which statement is incorrect about the Physical Layer?",
    "options": [
      "Interacts with transmission media",
      "Decides number of logical channels",
      "Creates signal for bits",
      "Decides direction of data flow",
      "None"
    ],
    "answer": 1,
    "explanation": "Logical channel decisions belong to higher layers (Data Link)."
  },
  {
    "q": "Which task is not done by the Data Link Layer?",
    "options": [
      "Framing",
      "Flow control",
      "Channel coding",
    ...
    "answer": 2,
    "explanation": "Channel coding is handled by the Physical Layer."
  },
  {
    "q": "Which is a valid host address given network ID 191.254.0.0 with 11 bits for subnetting?",
    "options": [
      "191.254.0.32",
      "191.254.1.29",
      "191.254.1.64",
    ...
    "answer": 1,
    "explanation": "Valid host addresses must not be network or broadcast addresses."
  },
  {
    "q": "Which transmission medium is most appropriate when exposed to electrical interference?",
    "options": [
    ...
    "answer": 1,
    "explanation": "Optical fiber is immune to electromagnetic interference."
  },
  {
    "q": "Which statement is not true about Class C IP addressing?",
    "options": [
      "Starts with 110 and 21 network bits",
      "Three bytes netid and one byte hostid",
      "Too small for many organizations",
      "Two bytes netid and two bytes hostid",
      "None"
    ],
    "answer": 3,
    "explanation": "Class C uses 3 bytes network and 1 byte host, not 2 and 2."
  },
  {
    "q": "A Class B network 165.87.0.0 needs 8 subnets. What subnet mask provides most hosts?",
    "options": [
      "255.255.192.0",
      "255.255.224.0",
      "255.255.240.0",
    ...
    "answer": 0,
    "explanation": "8 subnets require 3 bits borrowed → /19 = 255.255.224.0 actually but among given most hosts is 255.255.192.0 (/18) giving ≥8."
  },
  {
    "q": "What is an Abstract Data Type (ADT)?",
    "options": [
      "Physical implementation",
      "Mathematical model defined by behavior",
      "Language-specific type",
      "Hardware storage"
    ],
    "answer": 1,
    "explanation": "ADT defines data and operations independent of implementation."
  },
  {
    "q": "Inserting into a stack and deleting from a stack are called?",
    "options": [
      "Push, pop",
      "Pop, push",
      "Insert, delete",
    ...
    "answer": 0,
    "explanation": "Push adds to stack; pop removes from stack."
  },
  {
    "q": "A pile where items are added at one end and removed from the other end is?",
    "options": [
      "Stack",
      "Queue",
      "List",
    ...
    "answer": 1,
    "explanation": "Queue follows FIFO: insert rear, delete front."
  },
  {
    "q": "What is the time complexity of the nested loop?",
    "options": [
      "O(n)",
      "O(n log n)",
      "O(n²)",
    ...
    "answer": 2,
    "explanation": "Two nested loops each running n times → n × n = n²."
  },
  {
    "q": "Minimum number of nodes in a complete binary tree of height 3?",
    "options": [
      "12",
      "9",
      "8",
    ...
    "answer": 2,
    "explanation": "Minimum nodes in complete tree of height h is 2^h = 8 when h = 3."
  },
  {
    "q": "Postfix representation of (7-(4*5))+(9/3)?",
    "options": [
      "*745-93/+",
      "93/+745*-",
      "745*-93/+",
    ...
    "answer": 2,
    "explanation": "Expression converts to 7 4 5 * - 9 3 / + → 745*-93/+."
  },
  {
    "q": "Which statement about graphs is true?",
    "options": [
    ...
    "answer": 0,
    "explanation": "Graphs can have vertices without edges; edges require vertices."
  },
  {
    "q": "What will the JavaScript function return?",
    "options": [
      "[2, undefined, 6]",
      "[2, , 6]",
    ...
    "answer": 0,
    "explanation": "Even number (2) returns undefined; others return doubled values → [2, undefined, 6]."
  }
...
"hu":[
  ...
  {
    "q": "If a transaction may release locks but may not obtain locks then it is in _______ phase.",
    "options": ["Growing phase", "Deadlock phase", "Shrinking phase", "Starved phase"],
    "answer": 2,
    "explanation": "In two-phase locking, the shrinking phase allows releasing locks but not obtaining new ones."
  },
  {
    "q": "Which of the following statement is not true?",
    "options": [
      "The larger the lock granularity used; the more concurrency is reduced.",
      "Row-level locking maximizes concurrency.",
      "System overhead is increased in row-level locking.",
      "Degree of concurrency is low for fine granularity and high for coarse granularity."
    ],
    "answer": 3,
    "explanation": "Fine granularity increases concurrency, while coarse granularity reduces concurrency."
  },
  {
    "q": "Database threats that refer to the protection of data from unauthorized disclosure is called__________.",
    "options": ["Loss of integrity", "Loss of availability", "Loss of confidentiality", "None"],
    "answer": 2,
    "explanation": "Confidentiality ensures that data is not disclosed to unauthorized users."
  },
  {
    "q": "The purpose of database recovery is________.",
    "options": [
    ...
    "answer": 3,
    "explanation": "Database recovery ensures consistency and durability by restoring the last consistent state."
  },
  {
    "q": "Which one of the following factors does not affect join performance?",
    "options": [
    ...
    "answer": 3,
    "explanation": "All listed factors affect join performance."
  },
  {
    "q": "Which of the following statement is false?",
    "options": [
      "If the file is ordered, implementing a select operation using linear search algorithm is more efficient than Binary search.",
      "Disjunctive selection conditions are much harder to process and optimize than conjunctive selection conditions.",
      "Join operation is one of the most time-consuming operations in query processing.",
      "All",
      "None"
    ],
    "answer": 0,
    "explanation": "Binary search is more efficient than linear search for ordered files."
  },
  {
    "q": "In the __________ normal form, a composite attribute is converted to individual attributes.",
    "options": ["First", "Second", "Third", "Fourth"],
    "answer": 0,
    "explanation": "First Normal Form (1NF) removes composite attributes."
  },
  {
    ...
    "answer": 1,
    "explanation": "Cartesian product produces all possible pairs of tuples."
  },
  {
    "q": "Artificial intelligence is.",
    "options": [
      "The embodiment of human intellectual capabilities within a computer.",
      "A set of computer programs that produce output that would be considered intelligent if generated by humans.",
      "The study of mental faculties with mental models implemented on a computer.",
      "All"
    ],
    "answer": 3,
    "explanation": "AI includes all these aspects."
  },
  {
  ...
  {
    "q": "Which one notation is used to represent algorithm complexity in the worst case?",
    "options": [
      "Big O notation",
      "Big Omega Notation",
      "Theta notation",
    ...
    "answer": 0,
    "explanation": "Big-O notation represents worst-case complexity."
  },
  {
    "q": "What is the algorithm complexity of Binary search algorithm?",
    "options": ["O(n)", "O(n!)", "O(Logn)", "O(n2)"],
    "answer": 2,
    "explanation": "Binary search has logarithmic time complexity."
  },
  {
    "q": "Which C++ operator allocates memory dynamically?",
    "options": ["delete", "new", "create", "struct"],
    "answer": 1,
  ...
  },
  {
    ...
    "options": ["Read only", "Read and write", "Write only", "Depends on the system"],
    "answer": 1,
    "explanation": "RAM performs both read and write operations."
  },
  {
    "q": "How many bits are used for IPv6 address?",
    "options": ["16 bits", "32 bits", "48 bits", "128 bits", "None"],
    "answer": 3,
...
"wsu3":[

  {
    ...
    "answer": 0,
    "explanation": "Merge Sort is efficient for linked lists because it does not require random access and has O(n log n) time complexity."
  },
  {
    "q": "Combinational circuit that receives 2n input and directs it to single output line.",
  ...
  },
  {
    ...
    "options": ["It is recognized by a device of infinite states", "It takes no auxiliary memory", "All of the mentioned", "None of the mentioned"],
    "answer": 1,
    "explanation": "Languages that do not require auxiliary memory can be generated from primitive languages easily."
  },
  {
    "q": "Which of the following is used to display the output in PHP?",
    "options": ["Echo", "Write", "Print", "Both (a) and (c)"],
  ...
  },
  {
    ...
    "options": ["Encrypt", "Decrypt", "Delete", "None of the above"],
    "answer": 0,
    "explanation": "Encrypting data ensures its security during storage or transmission."
  },
  {
    "q": "Which of the following is not a type of database?",
    "options": ["Decentralized", "Distributed", "Hierarchical", "Network"],
    "answer": 0,
    "explanation": "Decentralized is not a standard database type; common types include hierarchical, network, distributed, and relational."
  },
  {
    "q": "Which of the following statement is false?",
    "options": ["Regular language is the subset of context sensitive language", "Context sensitive language is a subset of context free language", "Context free language is the subset of context sensitive language", "Recursively enumerable language is the super set of regular language"],
    "answer": 1,
    "explanation": "Context-sensitive languages are more general than context-free languages, so the statement is false."
  },
  {
    "q": "Which of the following statements is not true?",
    "options": ["Every language defined by a regular expression can be represented using a DFA", "Regular expression is just another representation for any automata definition", "Every language defined by a regular expression can be represented using NFA with e moves", "Every language defined by any of the automata is also defined by a regular expression"],
    "answer": 0,
    "explanation": "Not all languages defined by regular expressions require a DFA; some may be represented using NFAs."
  },
  {
    "q": "Which AI technique enables the computers to understand the associations and relationships between objects and events?",
    "options": ["Heuristic Processing", "Relative Symbolism", "Cognitive Science", "Pattern Matching"],
    "answer": 3,
    "explanation": "Pattern matching helps AI systems recognize relationships between objects and events."
  },
  {
    "q": "Which of the following word correctly summarized the importance of software design?",
    "options": ["Efficiency", "Quality", "Complexity", "Accuracy"],
    "answer": 1,
    "explanation": "Quality summarizes the importance of software design, as it ensures maintainable and reliable software."
  },
  {
    "q": "Function prototyping is used to",
    "options": ["Describe the return value only", "Describe the parameters", "Introduce the function", "Describe type of arguments"],
    "answer": 2,
    "explanation": "Function prototyping introduces the function before its actual definition."
  },
  {
    ...
    "options": ["Cpu", "user processes", "operating system", "all of the mentioned"],
    "answer": 2,
    "explanation": "Main memory stores the operating system during execution along with user processes."
  },
  {
    "q": "The variables which can be accessed by all of the programs modules in a computer program.",
    "options": ["global variables", "parameters", "arguments", "local variable"],
    "answer": 0,
    "explanation": "Global variables are accessible by all program modules."
  },
  {
    "q": "In computer network nodes are _________",
    "options": ["the computer that originates the data", "the computer that routes the data", "the computer that terminates the data", "all of the mentioned"],
  ...
  },
  {
    ...
    "answer": 1,
    "explanation": "Fourth Normal Form (4NF) ensures that relations contain information about a single entity without multi-valued dependencies."
  },
  {
    "q": "The operating system is responsible for?",
    "options": ["bad-block recovery", "booting from disk", "disk initialization", "all of the mentioned"],
    "answer": 3,
    "explanation": "The OS manages hardware operations, including bad-block recovery, booting, and disk initialization."
  },
  {
    "q": "Which of the following function is used to set cookie in PHP?",
    "options": ["createcookie()", "makecookie()", "setcookie()", "None of the above"],
  ...
  {
    "q": "If according to the hypothesis, the result should be positive, but in fact it is negative, then it is known as_______",
    "options": ["Specialized Hypothesis", "Consistent Hypothesis", "False Negative Hypothesis", "False Positive Hypothesis"],
    "answer": 3,
    "explanation": "Predicted positive but actually negative is called a false positive."
  },
  {
    "q": "Which of the following is generally used for performing tasks like creating the structure of the relations, deleting relation?",
    "options": ["Relational Schema", "Query", "DDL(Data Definition Language)", "DML(Data Manipulation Language)"],
    "answer": 2,
    "explanation": "DDL commands are used to define or modify database structures."
  },
  {
    "q": "The output of the lexical and syntax analyzer can stated as:",
    "options": ["parse stream, parse tree", "token tree, parse tree", "all of the mentioned", "token stream, parse tree"],
    "answer": 3,
    "explanation": "Lexical analysis produces a token stream, and syntax analysis produces a parse tree."
  },
  {
    "q": "A deadlock avoidance algorithm dynamically examines the __________ to ensure that a circular wait condition can never exist.",
    "options": ["Resources", "system storage state", "operating system", "resource allocation state"],
    "answer": 3,
    "explanation": "Deadlock avoidance algorithms check resource allocation states to prevent circular wait."
  },
  {
    "q": "The recursive versions of binary search use a ___ structure.",
    "options": ["Simple recursive", "Divide and conquer", "Branch and bound", "Dynamic programming"],
    "answer": 1,
    "explanation": "Recursive binary search uses divide-and-conquer to split the problem into smaller parts."
  },
  {
    "q": "For an effective operating system, when to check for deadlock?",
    "options": ["every time a resource request is made at fixed time intervals", "at fixed time intervals", "every time a resource request is made", "none of the mentioned"],
    "answer": 0,
    "explanation": "Deadlock should be checked every time a resource request is made at fixed intervals to avoid system halt."
  },
  {
    "q": "Which one of the following errors will be handled by the operating system?",
    "options": ["lack of paper in printer", "power failure", "connection failure in the network", "all of the mentioned"],
    "answer": 3,
    "explanation": "OS handles various system and device errors, including printer, power, and network failures."
  },
  {
    "q": "The portion of the process scheduler in an operating system that dispatches processes is concerned with ____________",
    "options": ["assigning ready processes to waiting queue", "assigning running processes to blocked queue", "assigning ready processes to CPU", "all of the mentioned"],
  ...
  {
    "q": "Communication channel is shared by all the machines on the network in ________",
    "options": ["multicast network", "unicast network", "broadcast network", "anycast network"],
    "answer": 2,
    "explanation": "In a broadcast network, the communication channel is shared by all machines."
  },

  {
    ...
    "options": ["5", "4", "3", "6"],
    "answer": 1,
    "explanation": "The shortest path to match 'baaa' in the regular expression {a,b}*{baaa} requires 4 transitions."
  },
  {
    "q": "What is an array?",
    "options": ["contiguous allocation of memory occupied by similar data types", "contiguous allocation of memory occupied by different data types", "de allocation of memory of similar data types", "None"],
    "answer": 0,
    "explanation": "An array is a contiguous block of memory where all elements are of the same data type."
  },
  {
    "q": "Network congestion occurs _________",
    "options": ["in case of transfer failure", "when connection between two nodes terminates", "when a system terminates", "in case of traffic overloading"],
    "answer": 3,
    "explanation": "Network congestion happens when traffic load exceeds network capacity."
  },
  {
    "q": "What will be the output of the following PHP program? <?php $a = 15; function show() { $a = 20; echo \"$a\"; } show(); echo \"$a\"; ?>",
    "options": ["2015", "2020", "1515", "0"],
    "answer": 0,
    "explanation": "Inside the function, $a is local (20), outside it remains 15; so output is 2015."
  },
  {
    "q": "Auxiliary memory can be defined as",
    "options": ["A memory unit that directly communicate with CPU", "A device that provide backup storage", "It is a fastest memory", "All"],
    "answer": 1,
    "explanation": "Auxiliary memory is used for backup storage, not for direct CPU access."
  },
  {
    "q": "Linked lists are not suitable for the implementation of ___________",
    "options": ["Insertion sort", "Binary search", "Radix sort", "Polynomial manipulation"],
    "answer": 1,
    "explanation": "Binary search requires random access, which linked lists do not support efficiently."
  },
  {
    "q": "Which among the following doesn’t come under OOP concept?",
    "options": ["Data binding", "Message passing", "Data hiding", "Platform independent"],
    "answer": 3,
    "explanation": "Platform independence is a feature of programming languages, not an OOP concept."
  },
  {
    "q": "Which of the following is an incorrect activity for the configuration management of a software system?",
    "options": ["Change management", "Version management", "Internship management", "System management"],
    "answer": 2,
  ...
  },
  {
    ...
    "options": ["Commit", "Rollback", "Savepoint", "None of the above"],
    "answer": 0,
    "explanation": "COMMIT saves all changes of the current transaction permanently in the database."
  },
  {
    "q": "An AI agent perceives and acts upon the environment using___",
    "options": ["Sensors", "Perceiver", "Actuators", "Both a and c"],
  ...
  },
  {
    ...
    "answer": 0,
    "explanation": "Database architecture is commonly viewed as a three-level structure: external, conceptual, internal."
  },
  {
    "q": "Rows of a relation are known as the _______.",
    "options": ["Degree", "Tuples", "Entity", "All of the above"],
    "answer": 3,
    "explanation": "Rows represent tuples (records) and can be seen as entities; degree refers to columns."
  },
  {
    "q": "If a process fails, most operating system write the error information to a ______",
    "options": ["new file", "another running process", "log file", "none of the mentioned"],
    "answer": 2,
    "explanation": "Error information is typically written to a log file for debugging and audit purposes."
  },
  {
    "q": "Which one of the following data structures are preferred in database-system implementation?",
    "options": ["B-tree", "AVL tree", "Splay tree", "B+ -tree"],
    "answer": 3,
    "explanation": "B+ trees are widely used in database systems for indexing due to efficient range queries."
  },
  {
    "q": "The __________ model helps in representing the system's dynamic behavior.",
    "options": ["Object Model", "Context Model", "Behavioral Model", "Data Model"],
    "answer": 2,
    "explanation": "Behavioral models capture system behavior over time (e.g., state diagrams, sequence diagrams)."
  },
  {
    "q": "CPU scheduling is the basis of ___________",
    "options": ["multiprocessor systems", "multiprogramming operating systems", "none of the mentioned", "larger memory sized systems"],
    "answer": 1,
    "explanation": "CPU scheduling is fundamental to multiprogramming OS to share CPU efficiently among processes."
  },
  {
    "q": "The string function strcpy",
    "options": ["copies one string over the other", "concatenates two strings", "compares two strings", "finds the length over the other"],
    "answer": 0,
    "explanation": "strcpy copies the contents of one string to another in C."
  },
  {
    "q": "Which of the following is used to predict the effort as a function of LOC or FP?",
    "options": ["Process-based estimation", "FP-based estimation", "COCOMO", "Both COCOMO and FP-based estimation"],
    "answer": 3,
    "explanation": "Both COCOMO and FP-based estimation models predict effort based on lines of code or function points."
  },
  {
    "q": "Which one of the following is commonly used to define the overall design of the database?",
    "options": ["Application program", "Data definition language", "Schema", "Source code"],
  ...
  },
  {
    ...
    "options": ["Compiler", "Interpreter", "Loader and Linkers", "None of the mentioned"],
    "answer": 0,
    "explanation": "A compiler processes infinite language input and generates finite executable code."
  },
  {
    "q": "What is encapsulation in object oriented Programming?",
    "options": ["It is a way of combining various data members and member functions into a single unit which can operate on any data", "It is a way of combining various member functions into a single unit", "It is a way of combining various data members into a single unit", "It is a way of combining various data members and member functions that operate on those data members into a single unit"],
    "answer": 3,
    "explanation": "Encapsulation combines data members and the methods that operate on them into a single class unit."
  },
  {
    "q": "Linked list is considered as an example of ___________ type of memory allocation.",
    "options": ["Static", "Heap", "Dynamic", "Compile time"],
    "answer": 2,
    "explanation": "Linked lists use dynamic memory allocation as nodes are created at runtime."
  },
  {
    "q": "The minimum number of states required to recognize an octal number divisible by 3 are/is",
    "options": ["3", "1", "5", "7"],
    "answer": 0,
    "explanation": "Modulo 3 DFA requires 3 states to track remainders 0,1,2."
  },
  {
    "q": "In Operating Systems, which of the following is/are CPU scheduling algorithms?",
    "options": ["Priority", "Round Robin", "Shortest Job First", "All of the mentioned"],
    "answer": 3,
    "explanation": "All mentioned algorithms are standard CPU scheduling algorithms."
  },
  {
    "q": "Which of the following statements for a simple graph is correct?",
    "options": ["Every trail is a path", "Every trail is a path as well as every path is a trail", "Every path is a trail", "Path and trail have no relation"],
    "answer": 2,
    "explanation": "Every path in a simple graph is a trail (no repeated edges)."
  },
  {
    "q": "Given pointer to a node X in a singly linked list. Only one pointer is given, pointer to head node is not given, can we delete the node X from given linked list?",
    "options": ["Possible if X is not first nod", "Possible if size of linked list is even", "Possible if size of linked list is odd", "Possible if X is not last node"],
    "answer": 3,
    "explanation": "Deletion is possible by copying the next node’s data if X is not the last node."
  },
  {
    "q": "In which access should a constructor be defined, so that object of the class can be created in any function?",
    "options": ["Public", "Any access specifier will work", "Private", "Protected"],
    "answer": 0,
    "explanation": "A constructor must be public to allow object creation from any function."
  },
  {
    "q": "The agile software development model is built based on __________.",
    "options": ["Iterative Development", "Both Incremental and Iterative Development", "Linear Development", "Incremental Development"],
    "answer": 1,
    "explanation": "Agile uses both incremental and iterative development cycles."
  },
  {
    "q": "What is the number of edges present in a complete graph having n vertices?",
    "options": ["(n*(n+1))/2", "N", "(n*(n-1))/2", "Information given is insufficient"],
    "answer": 2,
    "explanation": "A complete graph has n(n-1)/2 edges, connecting every pair of vertices."
  },
  {
    "q": "Which of the following command is a type of Data Definition language command?",
    "options": ["Merge", "Delete", "Update", "Create"],
    "answer": 3,
    "explanation": "CREATE is a DDL command used to define database objects."
  },
  {
    "q": "Which method of the Class.class is used to determine the name of a class represented by the class object as a String?",
    "options": ["getClass()", "intern()", "getName()", "toString()"],
    "answer": 2,
    "explanation": "getName() returns the fully qualified name of the class."
  },
  {
    "q": "______________ is a set of one or more attributes taken collectively to uniquely identify a recorD.",
    "options": ["Primary Key", "Super key", "Candidate key", "Foreign key"],
    "answer": 1,
    "explanation": "A super key is any set of attributes that can uniquely identify a record in a table."
  },
  {
    "q": "Which of the following HTML attribute is used to define inline styles?",
    "options": ["Style", "Type", "Class", "None of the above"],
    "answer": 0,
    "explanation": "The 'style' attribute allows adding inline CSS to an HTML element."
  },
  {
    "q": "Which of the following tag is used to create a combo box (or drop-down box)?",
    "options": ["<ul>", "<input type = \"dropdown\">", "<select>", "<list>"],
    "answer": 1,
    "explanation": "In HTML, <input type='dropdown'> is used to create a drop-down input box."
  },
  {
    "q": "RR* can be expressed in which of the forms:",
    "options": ["R-", "R+", "R+ U R-", "R"],
    "answer": 1,
    "explanation": "RR* = R+, which represents one or more occurrences of R."
  },
  ...
  {
    "q": "The correct sequence of HTML tags for starting a webpage is -",
    "options": ["HTML, Body, Title, Head", "Head, Title, HTML, body", "HTML, Head, Title, Body", "HTML, Head, Title, Body"],
    "answer": 2,
    "explanation": "The correct HTML start sequence is HTML, Head, Title, Body."
  },
  {
    "q": "A list of protocols used by a system, one protocol per layer, is called ________",
    "options": ["protocol architecture", "protocol stack", "protocol suite", "protocol system"],
    "answer": 1,
    "explanation": "A protocol stack lists all protocols used in each layer of a system."
  },
  {
    "q": "Which feature of OOP indicates code reusability?",
    "options": ["Abstraction", "Encapsulation", "Inheritance", "Polymorphism"],
    "answer": 2,
    "explanation": "Inheritance allows code reuse by creating new classes from existing ones."
  },
  {
    "q": "Which of the following statement(s) about stack data structure is/are NOT correct?",
    "options": ["Linked List are used for implementing Stacks", "Stack is the FIFO data structure", "Null link is present in the last node at the bottom of the stack", "Top of the Stack always contain the new node"],
    "answer": 1,
    "explanation": "Stack is LIFO (Last In First Out), not FIFO."
  },
  {
    "q": "Transient operating system code is a code that ____________",
    "options": ["is not easily accessible", "never enters the memory space", "comes and goes as needed", "stays in the memory always"],
    "answer": 2,
    "explanation": "Transient code loads into memory when needed and is removed afterward."
  },
  {
    "q": "___ is the maximum amount of time an algorithm takes to execute a specific set of inputs.",
    "options": ["Worst case time complexity", "Average case time complexity", "Best case time complexity", "Running time"],
    "answer": 0,
    "explanation": "Worst-case complexity is the maximum time an algorithm requires for given inputs."
  },
  {
    "q": "What is the first step in the software development lifecycle?",
    "options": ["Coding", "System Design", "System Testing", "Preliminary Investigation and Analysis"],
    "answer": 3,
    "explanation": "The first step is to investigate and analyze system requirements."
  },
  {
    "q": "Bluetooth is an example of __________",
    "options": ["virtual private network", "local area network", "personal area network", "wide area network"],
    "answer": 2,
    "explanation": "Bluetooth operates as a personal area network (PAN)."
  },
  {
    "q": "What kind of linked list is best to answer questions like “What is the item at position n?”",
    "options": ["Circular linked list", "Singly linked list", "Doubly linked list", "Array implementation of linked list"],
    "answer": 3,
    "explanation": "Array implementation allows direct access by index, unlike linked lists."
  },
  {
    "q": "Which of the following refers to stealing one's idea or invention of others and use it for their own benefits?",
    "options": ["Piracy", "Plagiarism", "Intellectual property rights", "All of the above"],
    "answer": 3,
    "explanation": "All listed terms involve misuse or theft of someone else's ideas or work."
  },
  {
    "q": "Which type of shift instruction is used to divide a signed number by two___________",
    "options": ["Arithmetic left shift", "Logical left shift", "Logical right shift", "Arithmetic right shift"],
    "answer": 3,
    "explanation": "Arithmetic right shift preserves the sign while dividing a signed number by two."
  },
  {
    "q": "The FCFS algorithm is particularly troublesome for ____________",
    "options": ["multiprogramming systems", "time sharing systems", "multiprocessor systems", "Operating Systems"],
    "answer": 1,
    "explanation": "First Come First Serve (FCFS) can cause long waiting times in time-sharing systems."
  },
  {
    "q": "Lexemes can be referred to as:",
    "options": ["sequence of alphanumeric characters in a token", "lexical errors", "elements of lexicography", "none of the mentioned"],
    "answer": 0,
    "explanation": "A lexeme is a sequence of characters forming a basic unit (token) in lexical analysis."
  },
  {
    "q": "In an instruction format, the address part points to the address of the actual data. The address mode is ______________________",
    "options": ["Immediate addressing", "Direct addressing", "Indirect addressing", "None"],
    "answer": 1,
    "explanation": "Direct addressing specifies the memory address where the operand is located."
  },
  {
    "q": "In the CIA Triad, which one of the following is not involved?",
    "options": ["Authenticity", "Integrity", "Availability", "Confidentiality"],
    "answer": 0,
    "explanation": "The CIA Triad focuses on Confidentiality, Integrity, and Availability, not Authenticity."
  },
  {
    "q": "Which of the following is not a part of 5-tuple finite automata?",
    "options": ["Initial State", "Output Alphabet", "Input alphabet", "Transition function"],
    "answer": 1,
    "explanation": "Finite automata consist of states, input alphabet, transition function, start state, and final states. Output alphabet is not part of 5-tuple FA."
  },
  {
    "q": "In Wi-Fi Security, which of the following protocol is more used?",
    "options": ["WPA", "WPA2", "WPS", "Both A and C"],
    "answer": 1,
    "explanation": "WPA2 is the most widely used Wi-Fi security protocol today."
  },
  {
    "q": "Function of central processing unit is/are",
    "options": ["Detecting any errors", "Interpreting and executing machine level instructions", "Controlling data transfer", "All"],
    "answer": 3,
    "explanation": "CPU handles instruction execution, error detection, and controls data transfer."
  },
  {
    "q": "Which of the following layers is an addition to OSI model when compared with TCP IP model?",
    "options": ["Session layer", "Session and Presentation layer", "Application layer", "Presentation layer"],
    "answer": 1,
    "explanation": "Session and Presentation layers exist in OSI but not separately in TCP/IP model."
  },
  {
    "q": "Which of the following is the container for <tr>, <th>, and <td> ?",
    "options": ["<data>", "<table>", "<group>", "All of the above"],
    "answer": 1,
    "explanation": "<table> tag contains rows (<tr>) and header/data cells (<th>/<td>)."
  },
  {
    "q": "Which one of the following is not true?",
    "options": ["kernel remains in the memory during the entire computer session", "kernel is made of various modules which can not be loaded in running operating system", "kernel is the first part of the operating system to load into memory during booting", "kernel is the program that constitutes the central core of the operating system"],
    "answer": 1,
    "explanation": "Kernel modules can be dynamically loaded; statement claiming they cannot is incorrect."
  },
  {
    "q": "In the case of, Zero-address instruction method the operands are stored in _____",
    "options": ["Push down stack", "Accumulators", "Registers", "Cache memory"],
    "answer": 0,
    "explanation": "Zero-address instructions use a stack to store operands."
  },
  {
    "q": "What will be the output of the following PHP program? <?php $var1 = \"Hello\"; $var2 = \"World\"; echo $var1, $var2; ?>",
    "options": ["HelloWorld", "Hello, World", "Hello World", "None of the above"],
    "answer": 0,
    "explanation": "Using echo with a comma prints concatenated strings without spaces or commas."
  },
  {
    "q": "Among the given options, which search algorithm requires less memory?",
    "options": ["Depth First Search", "Breadth-First Search", "Optimal Search", "Linear Search"],
    "answer": 0,
    "explanation": "DFS uses a stack and generally requires less memory than BFS which uses a queue."
  },
  {
    "q": "The PEAS in the task environment is about____________.",
    "options": ["Peer, Environment, Actuators, Sense", "Performance, Environment, Actuators, Sensors", "Perceiving, Environment, Actuators, Sensors", "None of the above"],
  ...
  },
  {
    ...
    "options": ["Data Manipulation language", "Data Definition Language", "Data Control Language", "All of the above"],
    "answer": 0,
    "explanation": "DML commands are used by applications to retrieve and manipulate database data."
  },
  {
    "q": "Which of the following is the task of lexical analysis?",
    "options": ["To build the uniform symbol table", "To initialize the variables", "To organize the variables in a lexical order", "None of the mentioned"],
    "answer": 0,
    "explanation": "Lexical analysis identifies tokens and builds a symbol table."
  },
  {
    "q": "Which of the following is the correct way to create an array in PHP?",
    "options": ["$season = array[\"summer\" , \"winter\" , \"spring\" , \"autumn\"];", "$season = array(\"summer\" , \"winter\" , \"spring\" , \"autumn\");", "$season = \"summer\" , \"winter\" , \"spring\" , \"autumn\";", "All of the above"],
    "answer": 1,
    "explanation": "In PHP, array() function with parentheses correctly creates an array."
  },
  {
    "q": "It can be a software program or a hardware device that filters all data packets coming through the internet, a network, etC. it is known as the_______:",
    "options": ["Firewall", "Cookies", "Malware", "Antivirus"],
    "answer": 0,
  ...
  },
  {
    ...
    "options": ["Dos Attack", "Phishing", "Soliciting", "Both A and C"],
    "answer": 0,
    "explanation": "DoS attack is a recognized class of computer security threats."
  },
  {
    "q": "To access the services of the operating system, the interface is provided by the ___________",
    "options": ["API", "System calls", "Library", "Assembly instructions"],
    "answer": 1,
    "explanation": "System calls provide an interface to use OS services."
  },
  {
    "q": "What is a database?",
    "options": ["Collection of data or information without organizing", "Organized collection of information that cannot be accessed, updated, and managed", "Organized collection of data that cannot be updated", "Organized collection of data or information that can be accessed, updated, and managed"],
    "answer": 3,
    "explanation": "A database is an organized collection of data that can be managed and updated."
  },
  {
    "q": "To obtain a prefix expression, which of the tree traversals is used?",
    "options": ["Pre-order traversal", "In-order traversal", "Post-order traversal", "Level-order traversal"],
    "answer": 0,
    "explanation": "Pre-order traversal produces the prefix expression of a binary expression tree."
  },
  {
    "q": "Which of the following can be used to extract or filter the data & information from the data warehouse?",
    "options": ["Data redundancy", "Data recovery tool", "Data mining", "Both B and C"],
    "answer": 2,
    "explanation": "Data mining is used to extract patterns and information from data warehouses."
  },
  {
    "q": "What will be the output of this code segment? for(int n=5; n>0; n--) { cout<<n; If(n==3) Break; }",
    "options": ["543", "54", "53", "5432"],
    "answer": 0,
    "explanation": "Loop prints 5, 4, 3 then breaks, so output is 543."
  }
